...
// The PRD path and ticket prefix placeholders in the prompt are automatically substituted.
func NewLoopWithEmbeddedPrompt(prdPath, ticketPrefix string, maxIter int) *Loop {
	prompt := embed.GetPrompt(prdPath, ticketPrefix)
